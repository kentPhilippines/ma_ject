...
<form id="UserForm" class="form-signin" action="javascript:0" method="post" novalidate="novalidate">
	<div class="layui-form" lay-filter="layuiadmin-form-admin"
		...
		<div class="layui-form-item">
		    <label class="layui-form-label">不可选选项</label>
		    <div class="layui-input-inline">
		...
		<div class="layui-layer-btn layui-layer-btn-">
			<a class="layui-layer-btn0" url = "${ctx}/manage/appAcount/appAccountManageAdd">确定</a><a class="layui-layer-btn1">取消</a>
		</div>
	</div>
</form>
</body>
